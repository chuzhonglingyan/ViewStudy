...
import com.yuntian.viewstudy.adapter.recyclerview.base.ItemViewDelegateManager;
...
public class MultiItemTypeAdapter<T> extends RecyclerView.Adapter<ViewHolder> {
    ...
    protected void setListener(final ViewGroup parent, final ViewHolder viewHolder, int viewType) {
        ...
        viewHolder.getConvertView().setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (mOnItemClickListener != null) {
                    int position = viewHolder.getAdapterPosition();
                    return onItemLongClickListener.onItemLongClick(v, viewHolder, position);
                }
                return false;
            }
        });
    ...
    public void addData(List<T> list) {
        ...
        mDatas.addAll(list);
        notifyItemRangeChanged(mDatas.size() - list.size(), list.size());
    }
